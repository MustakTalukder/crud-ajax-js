...
const BASE_URL = "http://localhost:3000/contacts"; // localhost server
...
window.onload = function() {
  ...
  // add eventlisterner to save
  let saveContactBtn = document.querySelector("#save");
